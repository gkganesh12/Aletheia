...
const productLinks = [
  { label: "Inscrape", href: "/products/inscrape" },
  { label: "Nirvana", href: "/products/nirvana" },
  { label: "SwarmScope", href: "/products/swarmscope" },
];
...
const linkClasses = "text-sm text-white/50 hover:text-white transition-colors duration-200";
...
function FooterLinkList({
  ...
  return (
    <div>
      <h4 className="mb-4 text-xs font-semibold uppercase tracking-[0.15em] text-white/70">
        {title}
      </h4>

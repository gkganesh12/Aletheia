          ...
          <div className="grid items-center gap-8 sm:gap-16 lg:grid-cols-[420px_1fr] lg:gap-24">
            ...
            <AnimatedSection delay={0.15}>
              <div className="space-y-6">
                ...
                <p className="text-2xl font-bold leading-snug text-ink md:text-3xl lg:text-4xl">
                ...
                <p className="text-base leading-relaxed text-muted md:text-lg">
                  ...
                  worked across full-stack development, cybersecurity, and
                  applied AI — building products that go beyond demos, focused
                  on actual usability and impact.
                </p>
                ...
                <div className="flex flex-wrap gap-2 pt-4">
                  {expertise.map((skill) => (
                    <span
                      key={skill}
                      className="rounded-full border border-ink/[0.08] bg-surface px-4 py-1.5 text-xs font-medium text-muted"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <Container>
          <div className="relative mx-auto max-w-4xl text-center">
            <AnimatedSection>
              ...
              <h2 className="mt-8 text-3xl font-bold leading-tight text-ink md:text-4xl lg:text-5xl">
                Most AI products are either{" "}
                <span className="text-muted">impressive in isolation</span> or{" "}
                <span className="text-muted">useless in real workflows.</span>
              </h2>
              ...
              <p className="mt-6 text-lg font-semibold text-ink md:text-xl">
        ...
        <Container>
          <AnimatedSection>
            <div className="mx-auto grid max-w-4xl gap-8 text-center sm:grid-cols-3 sm:gap-12">
              {aboutStats.map((stat) => (
                <div key={stat.label}>
                  <div className="text-3xl font-bold text-ink sm:text-5xl lg:text-7xl">
                    <AnimatedCounter
                      target={stat.target}
                      suffix={stat.suffix}
                      duration={2000}
          ...
          <div className="mx-auto mt-10 grid max-w-5xl gap-8 sm:mt-16 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
            {coreValues.map((value, i) => (
              <AnimatedSection key={value.number} delay={i * 0.1}>
                <div className="group">
                  <span className="text-5xl font-black text-muted transition-colors duration-500 group-hover:text-[var(--color-accent-400)]/15">
                    {value.number}
                  </span>

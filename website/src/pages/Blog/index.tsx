                ...
                >
                  ...
                  >
                    ...
                    <div className="flex h-full flex-col p-6">
                      ...
                      {/* Title */}
                      <h3 className="mb-2 text-lg font-semibold text-ink transition-colors duration-200 group-hover:text-[var(--color-accent-400)]">
                        {post.title}
                      </h3>
                      ...
                      <div className="mt-auto flex items-center gap-3 border-t border-ink/[0.06] pt-4 text-xs text-muted">
